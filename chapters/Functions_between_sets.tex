...
\begin{itemize}[nosep]
    ...
    \item Surjective functions: Consider all possible surjective functions, grouped by the partition \(\{f^{-1}(y_1), f^{-1}(y_2)\}\) of \(N\) they induce:
    \begin{itemize}[nosep]
      \item partition \(\{1,2\} \mid \{3\}\): \quad \( f_1: \{1, 2\} \mapsto y_1,\; 3 \mapsto y_2 \) \quad and \quad \( f_2: \{1, 2\} \mapsto y_2,\; 3 \mapsto y_1 \);
      \item partition \(\{2,3\} \mid \{1\}\): \quad \( f_3: \{2, 3\} \mapsto y_1,\; 1 \mapsto y_2 \) \quad and \quad \( f_4: \{2, 3\} \mapsto y_2,\; 1 \mapsto y_1 \);
      \item partition \(\{1,3\} \mid \{2\}\): \quad \( f_5: \{1, 3\} \mapsto y_1,\; 2 \mapsto y_2 \) \quad and \quad \( f_6: \{1, 3\} \mapsto y_2,\; 2 \mapsto y_1 \).
    \end{itemize}
