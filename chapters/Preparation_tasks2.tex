...
\section{Problem 1} Prove that the number of partitions of a positive integer $n$ into $k$ \textit{even} parts
is equal to the number of partitions of $n-k$ into $k$ \textit{odd} parts.
...
\section{Problem 2} Show that the number of partitions of a positive integer $n$ with at most $k$ parts is equal to the number of partitions of $2n$ into at most $k$ parts, all of which are even.
