...
\noindent\textbf{N1.} Prove that the num. of partitions of a positive int $n$ into $k$ \textit{even} parts % Blue arrow in notes labeled "even" correcting "equal" to "even" parts
