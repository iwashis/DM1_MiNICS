...
\begingroup
  % Redefine \section to produce a \subsection instead
  \renewcommand{\section}{\subsection}
  \input{chapters/Partitions_StirlingNumbers.tex}
\endgroup
...
\begingroup
  ...
  \let\maketitle\relax
  \input{chapters/Inclusion_Exclusion.tex}
\endgroup
...
\begingroup
  % Disable header commands from the included file:
  \renewcommand{\section}{\subsection}
  \input{chapters/Permutations_Derangements.tex}
\endgroup
...
\begingroup
  % Disable header commands from the included file:
  \let\maketitle\relax
  \input{chapters/Functions_between_sets.tex}
\endgroup
...
\begingroup
  % Disable header commands from the included file:
  \renewcommand{\section}{\subsection}
  \input{chapters/Generating_functions.tex}
\endgroup
...
\begingroup
  % Disable header commands from the included file:
  \renewcommand{\section}{\subsection}
  \input{chapters/Catalan_Numbers.tex}
\endgroup
